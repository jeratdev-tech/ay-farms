...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container mb-28"
    >
      ...
      <div className="relative flex-1 flex mt-36 md:rounded-full lg:rounded-full xl:rounded-full justify-center items-center  xl:min-h-screen max-xl:py-80 bg-primary bg-hero bg-cover bg-center">
        {/* <img
          src={bigShoeImg}
          alt="shoe colletion"
          width={410}
